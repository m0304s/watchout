...
class Settings(BaseSettings):
  ...
  MIN_FACE_WIDTH: int = Field(default=100, description="최소 얼굴 너비 (픽셀) - 근거리용")
  MIN_FACE_HEIGHT: int = Field(default=140, description="최소 얼굴 높이 (픽셀) - 근거리용")
  MIN_FACE_AREA: int = Field(default=14000, description="최소 얼굴 면적 (픽셀²) - 근거리용")
