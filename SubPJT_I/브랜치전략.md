...
main-ai          main-be          main-fe
    ...
    └── dev-ai       └── dev-be       └── dev-fe
            ...
            ├── hotfix-버그ID ├── hotfix-버그ID ├── hotfix-버그ID
...
- **목적**: 프로덕션 버그 긴급 수정
- **네이밍**: `hotfix-버그ID`
- **예시**: `hotfix-S13P21E102-101`, `hotfix-S13P21E102-102`
...
git checkout -b hotfix-S13P21E102-101

# Backend 긴급 수정
git checkout main-be
git pull origin main-be
git checkout -b hotfix-S13P21E102-102

# Frontend 긴급 수정
git checkout main-fe
git pull origin main-fe
git checkout -b hotfix-S13P21E102-103
```
...
#### Hotfix 브랜치
```
hotfix-S13P21E102-101  # AI 모델 오류 수정
hotfix-S13P21E102-102  # Backend API 버그 수정
hotfix-S13P21E102-103  # Frontend 렌더링 오류 수정
```
...
# 3. main-be에 병합
git checkout main-be
git merge hotfix-S13P21E102-102
...
# 5. 브랜치 정리
git branch -d hotfix-S13P21E102-102
git push origin --delete hotfix-S13P21E102-102
```
